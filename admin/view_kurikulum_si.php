...
$query = "SELECT * FROM kurikulum_si";
$result = mysqli_query($conn, $query);
?>

<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Data Kurikulum SI</h2>
        <!-- <a href="create_kurikulum_si.php" class="btn btn-primary">Tambah Kurikulum SI</a> -->
    </div>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td class='text-center'>
                                    <a href='edit_kurikulum_si.php?id=" . $row['id'] . "' class='btn btn-sm btn-warning btn-action'><i class='fas fa-edit'></i></a>
                                    <a href='delete_kurikulum_si.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger btn-action' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'><i class='fas fa-trash'></i></a>
                                  </td>";
                            echo "</tr>";
                        }
