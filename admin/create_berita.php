...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO berita (title, description, image_news, date) VALUES ('$title', '$description', '$image', '$date')";
    $conn->query($sql);
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Tambah Berita</h3>
                </div>
                <div class="card-body">
                    <form action="create_berita.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
