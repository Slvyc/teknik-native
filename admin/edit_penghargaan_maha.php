...
if (isset($_GET['id_penghargaan'])) {
    ...
    $result = $conn->query("SELECT * FROM penghargaan_mahasiswa WHERE id_penghargaan=$id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE penghargaan_mahasiswa SET gambar_person='$image', person='$person', prestasi='$prestasi', tingkat='$tingkat', tahun='$tahun', link='$link', date='$datePenghargaan' 
            WHERE id_penghargaan=$id";
    $conn->query($sql);
    header("Location: view_penghargaan_maha.php");
    exit;
}
?>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Edit Penghargaan Mahasiswa</h3>
                </div>
                <div class="card-body">
                    <form action="edit_penghargaan_maha.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="tahun" class="form-control" rows="4" required><?php echo $row['link']; ?></textarea>
                        </div>
