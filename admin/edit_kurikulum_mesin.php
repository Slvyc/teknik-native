...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = $conn->query("SELECT * FROM kurikulum_mesin WHERE id=$id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE kurikulum_mesin SET semester='$semester', kode_mk='$kodeMk', mata_kuliah='$mataKuliah', 
            sks='$sks', praktek='$praktek', teori='$teori', kategori_mk='$kategoriMk', rps='$rps' WHERE id=$id";
    $conn->query($sql);
     // Move the header redirection here
     header("Location: view_kurikulum_mesin.php");
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Edit Kurikulum Mesin</h3>
                </div>
                <div class="card-body">
                    <form action="edit_kurikulum_mesin.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="view_kurikulum_mesin.php" class="btn btn-secondary">
