...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO kurikulum_si (semester, kode_mk, mata_kuliah, sks, praktek, teori, kategori_mk, rps) 
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="create_kurikulum_si.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
