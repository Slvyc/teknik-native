...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO kurikulum_mesin (semester, kode_mk, mata_kuliah, sks, praktek, teori, kategori_mk, rps) 
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Tambah File Kurikulum Mesin</h3>
                </div>
                <div class="card-body">
                    <form action="create_kurikulum_mesin.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
