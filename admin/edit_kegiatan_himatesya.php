...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = $conn->query("SELECT * FROM kegiatan_himatesya WHERE id=$id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE kegiatan_himatesya SET title='$title', description='$description', image_news='$image', date='$date' WHERE id=$id";
    $conn->query($sql);
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Edit Kegiatan HIMATESYA</h3>
                </div>
                <div class="card-body">
                    <form action="edit_kegiatan_himatesya.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="view_kegiatan_himatesya.php" class="btn btn-secondary">
