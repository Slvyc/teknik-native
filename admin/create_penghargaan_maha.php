...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO penghargaan_mahasiswa (gambar_person, person, prestasi, tingkat, tahun, link, date) 
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Tambah Penghargaan Mahasiswa</h3>
                </div>
                <div class="card-body">
                    <form action="create_penghargaan_maha.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="view_penghargaan_maha.php" class="btn btn-secondary">
