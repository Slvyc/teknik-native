<?php
include 'db.php';
$result = $conn->query("SELECT * FROM kegiatan_akademik ORDER BY tanggal_pelaksanaan DESC");
?>
            ...
            <table class="download-table table table-hover" id="sop-download-table">
                ...
                <tbody class="download-table-body">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>" . date('d F Y', strtotime($row['tanggal_pelaksanaan'])). "</td>";
